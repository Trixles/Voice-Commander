...
from core.settings.helpers import (
    SHELL_ACTION_KEY, URL_ACTION_KEY, APP_ACTION_KEY, FILE_ACTION_KEY,
    _USER_ACTIONS, _HIDDEN_ACTIONS, _SELECTABLE_ACTIONS, _HIDDEN_COMMANDS,
    _PINNED_SLOT_NAMES, _ACTION_LABELS, _CONFIRM_ACTIONS, _CONFIRM_NOTE,
    DESKTOP_DIR, VOSK_MODELS_DIR,
    _display_name_from_action, _display_name_from_slug, _slug_from_name,
    _is_user_action, _has_slots, _sort_key,
    _load_desktop_apps, _load_config, _write_config,
