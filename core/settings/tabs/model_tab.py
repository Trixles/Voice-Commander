...
===============================
The "Model" tab. Picks the Vosk model directory used for speech
interpretation. Changing the model requires a service restart, so
...
SettingsDialog._browse_vosk_model method (which stays on the dialog
...
from core.commands import get_vosk_model_path
