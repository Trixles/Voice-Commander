...
def build(dialog: "SettingsDialog") -> QWidget:
    ...
    how_blurb = QLabel(
        ...
        "The Model tab lets you choose which Whisper model to use for speech "
        "interpretation. It ships with the base English model, which is a good "
        "balance of speed and accuracy for most setups. You can swap in a "
        "different model file if you want -- a larger one is more accurate but "
        "slower.\n\n"
